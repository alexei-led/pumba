...
func (_m *ContainerAPIClient) ContainerCommit(ctx context.Context, _a1 string, options container.CommitOptions) (common.IDResponse, error) {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *ContainerAPIClient) ContainerExecAttach(ctx context.Context, execID string, options container.ExecStartOptions) (types.HijackedResponse, error) {
...
func (_m *ContainerAPIClient) ContainerExecCreate(ctx context.Context, _a1 string, options container.ExecOptions) (common.IDResponse, error) {
	ret := _m.Called(ctx, _a1, options)
