...
func (_m *APIClient) ContainerDiff(ctx context.Context, _a1 string) ([]types.ContainerChange, error) {
...
func (_m *APIClient) ContainerTop(ctx context.Context, _a1 string, arguments []string) (types.ContainerProcessList, error) {
...
func (_m *APIClient) ImageHistory(ctx context.Context, image string) ([]types.ImageHistory, error) {
...
func (_m *APIClient) ImageInspectWithRaw(ctx context.Context, image string) (types.ImageInspect, []byte, error) {
	ret := _m.Called(ctx, image)
...
func (_m *APIClient) ImageRemove(ctx context.Context, image string, options types.ImageRemoveOptions) ([]types.ImageDelete, error) {
...
func (_m *APIClient) ImageTag(ctx context.Context, image string, ref string) error {
