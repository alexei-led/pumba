...
func (_m *MockClient) IPTablesContainer(_a0 context.Context, _a1 *Container, _a2, _a3 []string, _a4, _a5 []*net.IPNet, _a6 []string, _a7 []string, _a8 time.Duration, _a9 string, _a10 bool, _a11 bool) error {
